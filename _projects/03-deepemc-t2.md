...
summary: "A fast, dictionary-free approach for estimating T2 and proton-density maps directly from fewer multi-echo images."
...
DeepEMC-T2 replaces dictionary matching in conventional echo-modulation-curve T2 mapping with an efficient deep neural network that estimates quantitative maps from fewer echoes.
